...
function addons() {
	...
	return {
		...
		transform( code, id ) {
			...
			code = code.replace( 'build/dhtml-weixin.module.js', 'src/index.js' );
...
let builds = [
	{
		...
		output: [
			/*{
				format: 'esm',
				file: 'build/dhtml-weixin.module.js'
			}*/
		]
	},
	{
		...
		output: [
			/*{
				format: 'umd',
				name: 'THREE',
				file: 'build/dhtml-weixin.js',
				indent: '\t'
			},
			{
				format: 'cjs',
				name: 'THREE',
				file: 'build/dhtml-weixin.cjs',
				indent: '\t'
			}*/
		]
	},
		...
		output: [
			{
				format: 'umd',
				name: 'THREE',
				file: 'build/dhtml-weixin.min.js'
			}
		]
	}
];
