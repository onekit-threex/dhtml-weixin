...
const INDEX_SIZE_ERR = (ExceptionCode.INDEX_SIZE_ERR =
	((ExceptionMessage[1] = "Index size error"), 1));
const DOMSTRING_SIZE_ERR = (ExceptionCode.DOMSTRING_SIZE_ERR =
	((ExceptionMessage[2] = "DOMString size error"), 2));
const HIERARCHY_REQUEST_ERR = (ExceptionCode.HIERARCHY_REQUEST_ERR =
	((ExceptionMessage[3] = "Hierarchy request error"), 3));
const WRONG_DOCUMENT_ERR = (ExceptionCode.WRONG_DOCUMENT_ERR =
	((ExceptionMessage[4] = "Wrong document"), 4));
const INVALID_CHARACTER_ERR = (ExceptionCode.INVALID_CHARACTER_ERR =
	((ExceptionMessage[5] = "Invalid character"), 5));
const NO_DATA_ALLOWED_ERR = (ExceptionCode.NO_DATA_ALLOWED_ERR =
	((ExceptionMessage[6] = "No data allowed"), 6));
const NO_MODIFICATION_ALLOWED_ERR = (ExceptionCode.NO_MODIFICATION_ALLOWED_ERR =
	((ExceptionMessage[7] = "No modification allowed"), 7));
const NOT_FOUND_ERR = (ExceptionCode.NOT_FOUND_ERR =
	((ExceptionMessage[8] = "Not found"), 8));
const NOT_SUPPORTED_ERR = (ExceptionCode.NOT_SUPPORTED_ERR =
	((ExceptionMessage[9] = "Not supported"), 9));
const INUSE_ATTRIBUTE_ERR = (ExceptionCode.INUSE_ATTRIBUTE_ERR =
	((ExceptionMessage[10] = "Attribute in use"), 10));
// level2
const INVALID_STATE_ERR = (ExceptionCode.INVALID_STATE_ERR =
	((ExceptionMessage[11] = "Invalid state"), 11));
const SYNTAX_ERR = (ExceptionCode.SYNTAX_ERR =
	((ExceptionMessage[12] = "Syntax error"), 12));
const INVALID_MODIFICATION_ERR = (ExceptionCode.INVALID_MODIFICATION_ERR =
	((ExceptionMessage[13] = "Invalid modification"), 13));
const NAMESPACE_ERR = (ExceptionCode.NAMESPACE_ERR =
	((ExceptionMessage[14] = "Invalid namespace"), 14));
const INVALID_ACCESS_ERR = (ExceptionCode.INVALID_ACCESS_ERR =
...
DOMImplementation.prototype = {
	...
	createDocumentType(qualifiedName, publicId, systemId) {
		...
		// TODO:..
		//  readonly attribute NamedNodeMap     entitys;
...
Element.prototype = {
	...
	setAttributeNode(newAttr) {
		...
		this.attributes[newAttr.name] = {
			value,
			textContent: value == null ? "" : value.toString(),
		};
	...
	return new LiveNodeList(this, function (base) {
		...
		_visitNode(base, function (node) {
			if (node !== base && node.nodeType == ELEMENT_NODE) {
				if (selector.startsWith("[") && selector.endsWith("]")) {
					const selectorString = selector.substr(1, selector.length - 2);
					const key_value = selectorString.split("=");
